...
#                                                                                                 errors='ignore')
#
# syn_data = pd.read_csv(r"E:\FDI\OneDrive_1_1-15-2025\118\Datasets\PL_Class_FDI_NotScaled_lr0.03_1~1.3_100PL.csv")
...
real_data = real_data.drop(columns=columns_to_drop, errors='ignore').dropna().sample(5000)
...
# selected_columns = vlm_columns + vla_columns + vga_columns + pl_columns + vgm_columns + pg_columns + ql_columns
...
syn_data = pd.read_csv(r'PL_Class_FDI_NotScaled_lr0.03_1~1.3_100PL.csv').drop(columns=columns_to_drop, errors='ignore').dropna().sample(5000)
